...
/* 3 */
{
    //"_id" : ObjectId("57aabf9e2d35da6ffc807202"),
    "BUSINESS_NAME" : "ELTRA LLC",
    "LEGAL_NAME" : "ELTRA LLC",
    "ADDR1" : "254 Columbia Turnpike",
    "ADDR2" : "Suite 100",
    "CITY" : "Florham Park",
    "STATE" : "NJ",
    "ZIP" : "07932",
    ...
    "GEO_STATUS" : "PLACE_OK",
    //"GEO_DATE" : ISODate("2016-10-31T18:21:01.669Z"),
    "NAME" : "Eltra LLC",
    "GEO_loc" : {
        "type" : "Point",
        "coordinates" : [
    ...
    "GOOGLE_NAME" : "Eltra LLC",
    "place_id" : "ChIJNbAFfceow4kRpkU_ZPY0ZBU",
    "loc" : {
        "type" : "Point",
        "coordinates" : [
            -74.4038128,
...
for(i=0;i<input;i++)
{
  ...
  temp[i] = `Hospital Number ${i+1} is ${hospName[i]} and the Address is ${geoAdd[i]} with a Distance of ${geoDist[i]} miles`;
}
